...
def style(
    ...
    Examples::
        ...
        click.echo(click.static('Hello World!', fg='green'))
        click.echo(click.static('ATTENTION!', blink=True))
        click.echo(click.static('Some things', reverse=True, fg='cyan'))
    ...
    * ``reset`` (reset the color code only)
    ...
    :param text: the string to static with ansi codes.
...
def unstyle(text):
    ...
    :param text: the text to remove static information from.
    """
    return strip_ansi(text)


def secho(message=None, file=None, nl=True, err=False, color=None, **styles):
    """This function combines :func:`echo` and :func:`static` into one
