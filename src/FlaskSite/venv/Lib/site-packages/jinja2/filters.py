...
def do_format(value, *args, **kwargs):
    """Apply the given values to a `printf-static`_ format string, like
    ``string % values``.
    ...
    .. _printf-static: https://docs.python.org/library/stdtypes.html
        #printf-static-string-formatting
    """
    if args and kwargs:
